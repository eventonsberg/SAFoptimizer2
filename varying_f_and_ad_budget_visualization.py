...
def plot_facility_configuration_vs_f_and_ad_budget():
    type_f = st.session_state.varying_f_and_ad_budget_params["type_f"]
    results = st.session_state.varying_f_and_ad_budget_results
    data = []
    for budget, result in results.items():
...
def plot_costs_vs_f_and_ad_budget():
    C_f = st.session_state.varying_f_and_ad_budget_params["C_f"]
    C_A = st.session_state.varying_f_and_ad_budget_params["C_A"]
    results = st.session_state.varying_f_and_ad_budget_results
    f_and_ad_budgets = []
    facility_costs = []
    air_defense_costs = []
